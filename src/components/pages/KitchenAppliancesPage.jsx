...
const appliances = products.filter(p => p.category === 'kitchen-appliances')

export default function KitchenAppliancesPage() {
  return (
    <section className="py-5" style={{ minHeight: '80vh' }}>
      <div className="container mb-5">
        <div className="rounded-4 p-4 mb-5 d-flex flex-column flex-md-row align-items-center justify-content-between" style={{ background: 'linear-gradient(90deg, #43cea2 0%, #185a9d 100%)', boxShadow: '0 4px 32px rgba(0,0,0,0.10)' }}>
          <div className="text-white text-md-start text-center mb-3 mb-md-0">
            <h1 className="fw-bold mb-2" style={{ fontSize: '2.3rem', color: '#fff' }}>Kitchen Appliances</h1>
            <p className="mb-0" style={{ fontSize: '1.1rem', color: '#fff', opacity: 0.95 }}>
              Blenders, air fryers, mixers, and water dispensers for every modern kitchen.
            </p>
          </div>
          {appliances.length > 0 && (
            <img 
                ...
                <div className="card-body d-flex flex-column text-start p-3">
                  ...
                  <div className="mt-auto">
                    <div className="d-flex align-items-center mb-2">
                      <span className="fw-bold me-2" style={{ color: '#43cea2', fontSize: '1.2rem' }}>{item.price.toLocaleString()} FCFA</span>
